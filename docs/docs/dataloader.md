...
The standard data loader used for this system wraps around the pandas [data-reader](https://pandas-datareader.readthedocs.io/en/latest/) and [investpy](https://investpy.readthedocs.io/) libraries.
...
## Datareader Library
This class wraps around the pandas data-reader library which is configured to download historical stock data from [Yahoo Finance](https://uk.finance.yahoo.com/).
```python3
class DataLoader:
...
```
## Investpy Library
This class wraps around the investpy library which loads financial data from [Investing.com](https://www.investing.com/).
```python3
